'use strict';
angular.module('app.ui.bootstrapControllers', [])
  ...
  .controller('AlertDemoCtrl', function ($scope) {
    $scope.alerts = [
      ...
      {type: 'info', msg: 'Oh OK! Change a few things up and try submitting again.'},
  ...
  .controller('ModalDemoCtrl', function ($scope, $modal, $log) {
    ...
    $scope.open = function (size) {
      ...
      var modalInstance = $modal.open({
        templateUrl: 'views/sections/modal.html',
    ...
    $scope.tabs = [
      {
        ...
        content: 'Navs available in Bootstrap have shared markup, starting with the base .nav class, as well as shared states. Swap modifier classes to switch between each style.'
      },
      {
        title: 'Dynamic Title 2',
        content: 'For tabs with tabbable areas, you must use the tabs JavaScript plugin. The markup will also require additional role and ARIA attributes – see the plugin example markup for further details.',
        disabled: true
      }
    ];
